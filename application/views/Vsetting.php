      ...
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <div class="btn-group mb-2">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#UserModal"><i class="fas fa-plus"></i> Tambah</button>
          </div>
    ...
    <div class="modal-content">
      <form name="frmlogin" id="frmlogin" action="<?=base_url('Loket/setuser');?>" method="POST" >
        <div class="modal-header">
          <h5 class="modal-title" id="usertitle">Tambah Pengguna</h5>
